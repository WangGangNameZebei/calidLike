...
- (void)initialize {
    ...
    _selectedItemTitleColor = [UIColor colorFromHexCode:@"#00DA8C"];
    ...
    dividingLine.backgroundColor =[UIColor colorFromHexCode:@"#DCDCDC"];
...
- (void)setHideLine:(BOOL)hideLine{
    ...
    if (hideLine) {
        ...
        _dividingLine.backgroundColor = [UIColor clearColor];
        self.tracker.backgroundColor = [UIColor clearColor];
    }
}
...
- (void)setTrackerStyle:(SPPageMenuTrackerStyle)trackerStyle {
    ...
    switch (trackerStyle) {
        ...
        case SPPageMenuTrackerStyleRect:
            self.tracker.backgroundColor = [UIColor setipBlueColor];
