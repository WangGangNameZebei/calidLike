...
- (void)propertyActivationPostForUserData:(NSString *)userData userInfo:(NSString *)userInfo userEqInfo:(NSString *)userEqInfo userPhone:(NSString *)userPhone {
    ...
    NSDictionary *parameters = @{@"swipingData":userData,@"userInfo":userInfo,@"userEqInfo":userEqInfo ,@"accounts":userPhone,@"userDisableStatus":[NSString stringWithFormat:@"%ld",(long)self.stopBiaoshi],@"ppt_cell_id":[self userInfoReaduserkey:@"districtNumber"]};
